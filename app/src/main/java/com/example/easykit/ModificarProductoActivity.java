...
public class ModificarProductoActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void tomarFotosM(View view){
    ...
    public void elegirFotosM(View view){
